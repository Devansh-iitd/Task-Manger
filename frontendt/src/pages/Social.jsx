...
const Social = () => {
    ...
    return(
        ...
        <div className='grid grid-cols-5' style={{height:'100vh'}}>
            <div className='col-span-4 h-full' style={{backgroundColor:'#259875'}}>
                <h1 className=" text-5xl font-medium text-black mt-12 ml-24 w-fit font-sans ">Friends</h1>
       ...
       <div className='ml-14'>
        ...
        <div className='col-span-1' style={{backgroundColor:'#141349'}}>
            ...
            <h1 className=' text-lg font-medium text-white ml-6 w-fit mt-8 font-sans'>Friend Requests({requests.length})</h1>
        ...
        
            {
                ...
                requests.map((request) => {
                   ...
                   return (<div className=' w-fit'><img src={request.profilePic} className="w-10 h-10 rounded-full inline m-6 mr-2   "/><a className='text-white text-base font-medium w-12'>{request.username}</a>
                   {(request.requester === false)?<div className='w-fit inline'><button onClick={acceptRequest} data-username={request.username}   ><img src={tick} className='inline  h-8  w-min ml-10' /></button><button data-username={request.username} onClick={rejectRequest}><img src={cross} className='inline  h-8  w-min ml-2'/></button></div>:<a className="mt-4 text-white ml-24">Pending</a>} </div>
                   )
                })
            }
            </div>

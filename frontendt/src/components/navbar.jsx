...
const  Nav= () => {
  ...
  return (
   ...
   <div className=' bg-gradient-to-r from-purple-300 to-purple-600 flex  flex-row justify-between pt-2 pb-2 sticky top-0'>
    ...
    <h1 className=" font-bold text-gradient-to-r from-green-600 to-green-300 text-3xl ml-10 hover:cursor-pointer  " onClick={goHome}>TaskHub</h1>
    <div className="flex justify-around w-96 mr-16" >

      {localStorage.getItem('isAuthenticated') ? (<><button className=' text-md bg-pink-500 font-semibold rounded-full pt-2 pb-2 hover:bg-pink-700 pl-6 pr-6' onClick={HandleLogOut}>Log Out</button>
